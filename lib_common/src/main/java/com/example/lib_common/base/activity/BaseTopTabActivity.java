 ...
 * @note :
 */
public abstract class BaseTopTabActivity<V extends BaseView, T extends BasePresenter<V>> extends AppCompatActivity implements
    ...
    protected BaseTopTabFragment.TopTabFragmentPagerAdapter mAdapter;
